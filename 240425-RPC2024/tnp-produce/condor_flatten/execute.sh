...
DATA_DIR=$4
DATE=$5
DATA_PATH=${DATA_DIR}/${DATE}*/${DATA_TYPE}/*${DATA_TYPE}__${PERIOD}*/*/*/

CWD=$(pwd)
## make period, output, error dir
mkdir ${CWD}/${DATA_TYPE}__${PERIOD}
mkdir ${CWD}/${DATA_TYPE}__${PERIOD}/output
...
echo '        -o '${CWD}/${DATA_TYPE}__${PERIOD}'/output/flatten_$(basename $1)'                         >> ${CWD}/${DATA_TYPE}__${PERIOD}/condor.sh
