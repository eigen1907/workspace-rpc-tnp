...
python3 ${CMSSW_BASE}/src/RPCDPGAnalysis/NanoAODTnP/scripts/rpc-tnp-flatten-nanoaod.py \
        ...
        -o /u/user/sjws5411/Workspace/Efficiency/CMSSW_14_1_0_pre2/src/Workspace-RPC/240414-submit_crab_tnp_nanoaod/step2-condor_flatten/Muon1__Run2023D/output/flatten_$(basename $1)
